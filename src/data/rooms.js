...
export const rooms = [
  ...
  { slug: 'small-spaces', name: 'Small Spaces', title: 'Small Space Interior Design', tagline: 'Smart layouts, storage and scale for compact rooms and apartments.', tone: 'sand', image: '/images/small-spaces.webp', chips: [], gallery: [{ caption: 'Small living room', tone: 'sand', img: '/images/small-spaces.webp' }, { caption: 'Small bedroom', tone: 'stone', img: '/images/bedroom.webp' }, { caption: 'Studio corner', tone: 'warmgrey', img: '/images/studio-apartment.webp' }], filters: null, styleIdeas: [], tips: [], layouts: [], palettes: [], faqs: [], related: ['studio-apartment', 'living-room', 'bedroom', 'home-office'] },
];
